  ...
  if (!limited)
    ...
    result = await client
      ...
      .find({
        ...
        priceDiscounted: {
          $gt: parseInt(filter.priceRange.from),
          $lt: parseInt(filter.priceRange.to),
        },
        $or: [
      ...
      .skip((limited.pageNumber - 1) * limited.size)
      .limit(limited.size);
  }
...
async function upsertListingByEmail(
  client,
  emailOfListing,
  updatedListing,
  collection
